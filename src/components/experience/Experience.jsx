                ...
                <div className="container px-5 py-24 mx-auto">
                    <div className="flex flex-col text-center w-full mb-20 ">
                        ...
                        <p data-aos="fade-up" data-aos-delay="400" className="lg:w-2/3 mx-auto leading-relaxed text-base" >
                            graphic designer with 6+ years of experience crafting compelling visuals. He’s passionate about social media, branding, book cover, and helping clients bring their ideas to life.
                        </p>
                    </div>
